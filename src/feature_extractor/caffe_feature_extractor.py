...
# Model prototxt file
model_prototxt = caffe_root + 'models/placesCNN/places205CNN_deploy_FC7.prototxt'

# Model caffemodel file
model_trained = caffe_root + 'models/placesCNN/places205CNN_iter_300000.caffemodel'
